...
<div class="container">
	...
	<section>
		...
		<p>ログ調査やgrepコマンドを利用して原因を特定し、 git pull と再デプロイによって解決しました。</p>
	</section>
...
<section id="works">
	...
	<div class="gallery">
		<figure>
			<img src="img/taskapp-login.png" alt="タスク管理アプリ ログイン画面" class="screenshot">
			<figcaption>ログイン画面</figcaption>
		</figure>

		<figure>
			<img src="img/loginshot.png" alt="ログイン画面" class="screenshot">
			<figcaption>ログイン画面（別バージョン）</figcaption>
		</figure>

		<figure>
			<img src="img/register.png" alt="新規登録画面" class="screenshot">
			<figcaption>新規登録画面</figcaption>
		</figure>

		<figure>
			<img src="img/taskboard.png" alt="ダッシュボード画面" class="screenshot">
